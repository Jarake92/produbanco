...
public sealed class ProxyTelefono : ApiClient, IProxyListadoOperacion<Telefono>
{
    public ProxyTelefono(IHttpClientFactory httpClient, IOptions<Rootobject> configuration, ILogger<ApiClient> logger)
        : base(httpClient, configuration, ProxyConstantes.NombresHttpClient.Telefono, logger)
    {
    }
    ...
    public async Task<string> PostAsync(Telefono value)
    {
        return await PolicyWrap.ExecuteAsync(async () =>
        {
